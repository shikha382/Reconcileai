...
def main() -> None:
    ...
    print("is intentionally only a proxy over the deterministic MockAIProvider,")
    print("not a live-model benchmark. In this dataset the mock AI recommended")
    print("zero direct auto-resolutions, so it produced no measurable unsafe")
    print("rate and no measurable automation lift. The 14.67% unsafe contrast")
    print("belongs to Baseline C alone. ReconcileAI's verification and policy")
    print("layers remain the authority regardless of provider recommendation.")
    print("=" * 70)
